...
// Process the check outcome, update the check data as needed, trigger an alert to the user if needed, and save the check data
...
workers.log = function(originalCheckData, checkOutcome, state, alertWarranted, timeOfCheck) {
    ...
    const logFileName = originalCheckData.id; // Using the check ID as the log file name

    // Append the log string to the file, creating a new file if needed
