...
helpers.sendTwilioSms = (phone, msg, callback) => {
    ...
    // const normalizedPhone = phone && /^0\d{9}$/.test(phone) ? phone.slice(1) : (phone && /^\d{9}$/.test(phone) ? phone : false);
...
// Take a given string and a data object and find/replace all the keys within the string with the values from the data object
