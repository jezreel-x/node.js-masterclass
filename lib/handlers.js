...
handlers.index = (data, callback) => {
    ...
    if (data.method == 'get') {
        ...
        const templateData = {
            ...
            'body.description': 'We offer free uptime monitoring for HTTP/HTTPS sites of all kinds. When your site goes down, we\'ll send you a text to let you know.',
        };
...
handlers.public = (data, callback) => {
    if (data.method == 'get') {
        const assetName = data.normalizedPath.split('/')[1];
